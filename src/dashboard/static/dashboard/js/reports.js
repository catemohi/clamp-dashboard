  ...
  responce.done(function ( data ) {
    let dataSet = [
      ...
      [ 5, 'Нагрузка первой линии относительно нормы',
        data.desired_date.sl.first_line.rating_to_nominal, '-' ],
      [ 6, 'Нагрузка первой линии относительно дня сравнения',
        data.desired_date.sl.first_line.rating_to_comparison, '-' ],
      ...
      [ 11, 'Нагрузка VIP линии относительно нормы',
        data.desired_date.sl.vip_line.rating_to_nominal,
        '-' ],
      [ 12, 'Нагрузка VIP линии относительно дня сравнения',
        data.desired_date.sl.vip_line.rating_to_comparison,
        '-' ],
      ...
      [ 17, 'Общая нагрузка относительно нормы',
        data.desired_date.sl.general.rating_to_nominal,
        '-' ],
      [ 18, 'Общая нагрузка относительно дня сравнения',
        data.desired_date.sl.general.rating_to_comparison,
        '-' ],
      ...
      [ 22, 'Общая нагрузка относительно нормы',
        data.desired_date.mttr.rating_to_nominal,
        '-'],
      ...
      [ 26, 'Общая нагрузка относительно нормы',
        data.desired_date.flr.rating_to_nominal,
        '-'],
      [ 27, 'Общая нагрузка относительно дня сравнения',
        data.desired_date.flr.rating_to_comparison,
        '-']
      ];
